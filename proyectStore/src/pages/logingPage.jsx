...
export const LogingPage = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-8 bg-gray-950 rounded-2xl shadow-lg shadow-gray-400 text-[#4CE9D7]">
            ...
            <form onSubmit={(e) => onSubmita(e)} action="login" className="grid grid-cols-1 gap-4 my-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    <a href="/create-account" className="bg-white text-center text-[#0f9c8c] font-bold rounded-2xl py-2 px-4 hover:bg-[#4CE9D7] hover:text-black cursor-pointer">Crear</a>
